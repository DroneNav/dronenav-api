...
DRONEPORT_LAUNCH_SEPARATION_SECONDS = 60
...
DRONEPORT_LANDING_SPACE_STATUS_ACTIVE = "active"
DRONEPORT_LANDING_SPACE_STATUS_INACTIVE = "inactive"
...
MAX_DRONEPORT_LANDING_SPACES = 16
