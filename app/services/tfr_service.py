...
def build_demo_tfr(current_datetime):
    """Return synthetic normalized TFR for DroneNav demonstrations."""
    ...
    normalized_schedule = normalize_tfr_schedule(
        None,
        begins_at,
        ends_at,
    )
    ...
    return {
        "notam_id": "TEST/0001",
        "title": "DroneNav Demonstration TFR",
        "issued_at": begins_at,
        "begins_at": begins_at,
        "ends_at": ends_at,
        "airspace_usages": [
            {
                "airspace_id": "DRONENAV-DEMO-TFR",
                "geometry_components": [
                    {
                        "operation": "BASE",
                        "geometry": {
                ...
                "layers": [
                    {
                        "lower_altitude": {
                            ...
                            "unit": "FT",
                            "raw_reference": "SFC",
                            "resolved_reference": "SFC",
                        },
                        "upper_altitude": {
                            "value": "400",
                            "unit": "FT",
                            "raw_reference": "MSL",
                            "resolved_reference": "MSL",
                        },
                        "altitude_interpretation": None,
                        "schedules": [],
        ...
        "faa_text": (
            "<p><strong>TEST/0001 — "
            "DroneNav Demonstration TFR</strong></p>"
            "<p>This is a synthetic Temporary Flight Restriction "
            "generated by DroneNav for demonstration and testing "
            "purposes. It is not an FAA restriction and is not "
            "valid for operational use.</p>"
        ),
    }


def get_demo_tfr_feature():
    """Return synthetic WFS-style TFR feature for demos."""
